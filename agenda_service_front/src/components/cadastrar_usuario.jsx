    ...
    <div className="container">
        ...
        <form onSubmit={handleSubmit(salvar)}>
            ...
            <div className="form-group mt-2">
                ...
                <input type="number" className="form-control" id="telefone" required {...register("numero_telefone")} />
            </div>
            <div className="form-group mt-2">
            ...
            <div className="form-group mt-2">
                ...
                <input type="number" className="form-control" id="cidade" required {...register("cidade_id")} />
            </div>
            <div className="form-group mt-2">
